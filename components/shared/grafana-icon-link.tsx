...
// 그라파나 공식 로고(그라디언트 spiral)를 인라인 SVG로 표현한 외부 링크.
// 기본은 inline 배치. absolute 배치가 필요하면 className으로 override.
export function GrafanaIconLink({ href, label = "Open in Grafana", className }: Props) {
  return (
    <a
      href={href}
      target="_blank"
    ...
    >
      <svg viewBox="0 0 351 365" className="size-4" aria-hidden="true" focusable="false">
        <linearGradient
          id="grafana-icon-gradient"
        ...
        <path
          fill="url(#grafana-icon-gradient)"
